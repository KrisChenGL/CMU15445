...
class UpdatePlanNode : public AbstractPlanNode {
 public:
  ...
  // Copy constructor for CloneWithChildren
  UpdatePlanNode(const UpdatePlanNode &other)
      : AbstractPlanNode(other.output_schema_, other.children_),
        table_oid_{other.table_oid_},
        target_expressions_(other.target_expressions_) {}
