...
class BufferPoolManager {
 public:
  ...
  auto UnpinPage(page_id_t page_id, bool is_dirty_, AccessType access_type = AccessType::Unknown)->bool;
 ...
 private:
  ...
  auto Allcoate()->page_id_t;
  
  void DeallcoatePage(__attribute__((unused)) page_id_t page_id){
